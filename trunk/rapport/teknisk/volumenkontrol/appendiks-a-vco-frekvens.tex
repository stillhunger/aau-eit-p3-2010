...
V_L = \frac{R_7||R_6}{R_{10} + R_7||R_6} \cdot V_{CC} = \frac{R_7 \cdot R_6}{R_{10} \cdot R_6 + R_{10} \cdot R_7 + R_7 \cdot R_6} \cdot V_{CC}
\end{equation}
...
Da operationsforstærkeren ikke er i stand til at levere forsyningsspænding som udgangsspænding, men kun $V_{CC} - 1,5$ V Udfra ligning (\ref{equ:appendiks-vco3}) kan $"$Upper triggerlevel$"$ beregnes.
