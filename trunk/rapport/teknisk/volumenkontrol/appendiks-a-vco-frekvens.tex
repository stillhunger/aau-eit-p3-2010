...
Da operationsforstærkeren ikke er i stand til at levere forsyningsspænding som udgangsspænding, men kun $V_{CC} - 1$ V Udfra ligning (\ref{equ:appendiks-vco3}) kan $"$Upper triggerlevel$"$ beregnes.
