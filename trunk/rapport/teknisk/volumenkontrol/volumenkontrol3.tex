...
Som det ses på figur \ref{fig:vco-signal} svinger udgangen på integratoren mellem schmidt-triggerens to niveauer. Det kan også ses udfra grafen hvornår VCO'ens udgang er høj, dette er når integratorens udgang, blå kurve, er højere end $U_{6_{\mathrm{in+}}}$, rød kurve.
