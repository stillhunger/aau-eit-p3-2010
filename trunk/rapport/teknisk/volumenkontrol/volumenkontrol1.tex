...
V_{CC} - V_D = \frac{I_{konst} \cdot t}{C_2} \Rightarrow \mathrm{4,5~V} = \frac{I_{konst} \cdot 3~\mathrm{s}}{5~\mu \mathrm{F}} \Rightarrow I_{konst} = \mathrm{7,5~\mu A}
\end{equation}
...
V_D = R_{11} \cdot I_{konst} \Rightarrow \mathrm{0,5~V} = R_{11} \cdot \mathrm{7,5~\mu A} \Rightarrow R_{11} = \mathrm{66,7~k\ohm}
\end{equation}
