...
T-model-parameteren $r_e$ er givet ved udtrykket i formel (\ref{equ:beta-re}) \cite{sedra-smith-7}%\kilde{afsnit 4.5.7 i sedra smith}.
...
Closed-loop forstærkningen, $A_f$, som er givet ved udtrykket vist i formel (\ref{equ:af_def}) \cite{sedra-smith-8}%\kilde{formel 9.4 i sedra smith}
, ønskes til 8,95. Dette skyldes at der, som beregnet i afsnit \ref{valg_kortslutningssikring}, skal være 17,9 V over belastningen når der kommer 2 V som input til effektforstærkeren.
...
Tilbagekoblingskredsløbet opbygges som en spændingsdeler, som vist på figur \ref{fig:beta-clean}, hvormed closed-loop forstærkningen, $A_f$, bliver som vist i formel (\ref{equ:af-deler}) \cite{sedra-smith-9}.%\kilde{eksempel 9.1 i sedra smith}
