...
\caption{Klasse A $i_c (Q1)$ karakteristik}
\label{fig:klassea}
\end{minipage}
\hspace{0.5cm}
\begin{minipage}[b]{0.5\linewidth}
...
\caption{Eksempel på klasse A udgangstrinskredsløb}
\label{fig:classa}
\end{minipage}
\end{figure}
...
I et klasse A udgangstrin løber altid en konstant strøm gennem Q2, hvis kredsløbet på figur \ref{fig:classa} benyttes. Dette gør at den maksimale teoretiske virkningsgrad kun er 25\%. \fixme{kilde: til sedra smith}
...
\caption{Klasse B $i_c (Q1)$ karakteristik}
\label{fig:klasseb}
\end{minipage}
\hspace{0.5cm}
\begin{minipage}[b]{0.5\linewidth}
...
\caption{Eksempel på Klasse B udgangstrin med crossoverdistortion}
...
Et klasse B udgangstrin har en maksimal nyttevirkning på 78,5 \%.\fixme{kilde: til sedra smith}
...
Et klasse AB udgangstrin har en nyttevirkning som ligger mellem den for et klasse A og et klasse B. \fixme{kilde: Jan ???}
