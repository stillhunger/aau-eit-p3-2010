...
Frekvensgangen og THD blev målt for de forskellige indgange. Her er resultater vist for mikrofonindgangen ved forskellige indstillinger. Resten af resultaterne kan findes på CD'en\fixme{henvisning}. Spændingsniveauer angivet i V og mV er amplitude værdier. 

Mikrofonindgangens frekvensgang, ved et frekvens sweep ved 200 mV vises i figur \ref{fig:apind:frek200mv}.
\begin{figure}[h]
\centering
\includegraphics[scale=textwidth]{Indgangsvlger mic 200mv frek.png}
\caption{Frekvensgangen for mikrofonindgangen på indgangsvælgeren ved 200 mV.}
\label{fig:apind:frek200mv}
\end{figure}

Mikrofonindgangens THD, ved et frekvens sweep ved 200 mV vises i figur \ref{fig:apind:thd200mv}.
\begin{figure}[h]
\centering
\includegraphics[scale=textwidth]{Indgangsvlger mic 200mv thd.png}
\caption{THD for mikrofonindgangen på indgangsvælgeren ved 200 mV.}
\label{fig:apind:thd200mv}
\end{figure}

Mikrofonindgangens frekvensgang, ved et frekvens sweep ved 2 V vises i figur \ref{fig:apind:frek2v}.
\begin{figure}[h]
\centering
\includegraphics[scale=textwidth]{Indgangsvlger mic 2v frek.png}
\caption{Frekvensgangen for mikrofonindgangen på indgangsvælgeren ved 2V.}
\label{fig:apind:frek2v}
\end{figure}

Mikrofonindgangens THD, ved et frekvens sweep ved 2 V vises i figur \ref{fig:apind:thd2v}.
\begin{figure}[h]
\centering
\includegraphics[scale=textwidth]{Indgangsvlger mic 200mv thd.png}
...
Mikrofonindgangens frekvensgang for et slukket signal, ved et frekvens sweep ved 2 V vises i figur \ref{fig:apind:frek2vslukket}.
\begin{figure}[h]
\centering
\includegraphics[scale=textwidth]{Indgangsvlger mic 2v frek.png}
\caption{Frekvensgangen for mikrofonindgangen for et slukket signal, på indgangsvælgeren ved 2V.}
\label{fig:apind:frek2vslukket}
\end{figure}

Mikrofonindgangens THD for et slukket signal, ved et frekvens sweep ved 2 V vises i figur \ref{fig:apind:thd2vslukket}.
\begin{figure}[h]
\centering
\includegraphics[scale=textwidth]{Indgangsvlger mic 200mv thd.png}
