...
Målingerne foretages med to forskellige opstillinger; én til impedansmåling og én til forstærkning-, frekvensgang- og forvrængningsmåling. Opstillingerne er vist på figur \ref{fig:maaleop-imp} og figur \ref{fig:maaleop-thd:forfor}.%\fixme{kilde: Ole Kiel Jensen, mm5 maaleteknik}
...
\item Testobjektet tilsluttes som på figur \ref{fig:maaleop-thd:forfor}
