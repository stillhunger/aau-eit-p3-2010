...
V_{\mathrm{opamp}} = \frac{R_7||R_{10}}{R_6 + R_7||R_{10}} \cdot (V_{CC} - 1,5) = \frac{R_6 \cdot R_7}{R_6 \cdot R_7 + R_6 \cdot R_{10} + R_7 \cdot R_{10}} \cdot V_{CC}
\end{equation}

\begin{equation}
\label{equ:appendiks-vco3c}
V_U = V_{\mathrm{supply}} + V_{\mathrm{opamp}} = 
\end{equation}
