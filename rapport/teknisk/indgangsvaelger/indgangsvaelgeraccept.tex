...
Dæmpningen af et tændt signal ved referencefrekvensen, 1 kHz, er i målingen aflæst til 0,034 dB. Den frekvens som afviger mest fra denne værdi er ved 20 kHz, som aflæses til en dæmpning på 0,13 dB. Dette giver en afvigelse på ca. 0,1 dB, hvilket er acceptabelt. \fixme{Sammenlign med simulering og kravspec}

Målingerne viser, på figur \ref{fig:indaccept:slukketmaaling}, at dæmpning ved 1 kHz er på ca. 114 dB, hvilket er acceptabelt. \fixme{sammenlign sammenlign sammenlign! (samme fix som foregående)}
\begin{figure}[h]
\centering
