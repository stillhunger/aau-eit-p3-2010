...
\end{equation}
For at få en dæmpning på 3~dB, som er den ønskede dæmpning i knækpunktet, skal $\frac{V_{out}}{V_{in}}=10^{\frac{-3}{20}}\approx0.7$. 
...
\end{equation}
f bestemmes til 2~hz, én dekade før den ønskede, for at opnå en lav dæmpning ved de ønskede 20~hz. Dæmpningen ved 20~hz kan så udregnes ud fra formlen for et standard højpasfilter:
\begin{equation}
%\tau = R\cdot C
...
\begin{equation}
\frac{1}{\sqrt{1.01}}\approx -0.043~dB
\end{equation}
