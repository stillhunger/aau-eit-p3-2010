...
Størrelsen af $P_D$ er effekten afsat i en enkelt udgangstransistor og er givet ved udregningen i formel (\ref{equ:pd})\fixme{kilde: Jan Mikkelsen, mm19}. Denne formel er ganske vist gældende for klasse B udgangstrin, men i dette arbejdsområde er den også gældende for klasse AB udgangstrin\fixme{kilde: Ole}.
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.4]{teknisk/effektforstaerker/term-runoff.png}
\caption{Diagram over strømforstærkeren}
\label{fig:blokdiagram-stroem}
\end{figure}