\section{Accepttest}
\label{acceptest}
Efter systemet implementeredes, blev der udført målinger, som vist i appendiks \ref{maalerapport-system}\fixme{Ret sti}. Ud fra disse kan der konkluderes at systemet lever op til størstedelen af de opstillede krav. 
