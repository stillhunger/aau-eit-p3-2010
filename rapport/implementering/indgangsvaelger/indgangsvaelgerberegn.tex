...
5V*\frac\frac{1}{\frac{1}{R_2}+\frac{1}{R_3}}{R_1+\frac{1}{\frac{1}{R_2}+\frac{1}{R_3}}}=1.11V
\end{equation}
...
Modstanden $R_3$ er valgt ud fra, at signalet skal se en indgangsimpedans på minimum 22k\ohm. Når transistoren er tændt er indgangsimpedansen mindst. $R_1$, $R_2$ og $R_3$ sidder så alle parallelt hvilket giver:
\begin{equation}
\frac{1}{\frac{1{}R_1}+\frac{1}{R_2}+\frac{1}{R_3}}=22k\ohm
R_3=39.29k\ohm
\end{equation}
